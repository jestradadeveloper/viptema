...
<!--	<span class='payment-errors required'></span>-->
    ...
    <div class="form-row form-row-first">
        <label for="openpay-card-expiry">Expira MES <span class="required">*</span></label>
        <input id="openpay-card-expiry" class="input-text wc-credit-card-form-card-expiry" type="text" autocomplete="off" placeholder="MM" data-openpay-card="expiration_month" />
        <label for="openpay-card-expiry">Expira AÑO <span class="required">*</span></label>
        <input id="openpay-card-expiry" class="input-text wc-credit-card-form-card-expiry" type="text" autocomplete="off" placeholder="YY" data-openpay-card="expiration_year" />
